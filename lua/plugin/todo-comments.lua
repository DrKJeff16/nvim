  ...
  config = function()
    require('todo-comments').setup({
      ...
      keywords = {
        ...
        TODO = { icon = ' ', color = 'info', alt = { 'PENDING', 'MISSING' } },
        HACK = { icon = ' ', color = 'warning', alt = { 'TRICK', 'SOLUTION', 'ADHOC', 'SOLVED' } },
        WARN = { icon = ' ', color = 'warning', alt = { 'ATTENTION', 'ISSUE', 'PROBLEM', 'WARNING', 'XXX' } },
        PERF = { icon = ' ', color = 'info', alt = { 'OPTIM', 'OPTIMIZED', 'PERFORMANCE' } },
        NOTE = { icon = ' ', color = 'hint', alt = { 'INFO', 'MINDTHIS', 'TONOTE', 'WATCH' } },
