  ...
  config = function()
    ...
    require('user_api.config.keymaps').set({
      n = {
        ...
        ['<leader>PC'] = { ':Pipenv! clean<CR>', desc('Clean (Verbose)', false) },
        ...
        ['<leader>PV'] = { ':Pipenv! verify<CR>', desc('Verify (Verbose)', false) },
        ['<leader>Pc'] = { ':Pipenv clean<CR>', desc('Clean', false) },
        ...
        ['<leader>Pv'] = { ':Pipenv verify<CR>', desc('Verify', false) },
      },
    })
  end,
}
