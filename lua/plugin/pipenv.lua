  ...
  config = function()
    ...
    require('user_api.config.keymaps').set({
      n = {
        ...
        ['<leader>P<CR>'] = { ':Pipenv ', desc('Prompt', { silent = false }) },
        ['<leader>PC'] = { ':Pipenv! clean<CR>', desc('Clean (Verbose)') },
        ['<leader>PI'] = {
          ':Pipenv! install ',
          desc('Prompt To Install (Verbose)', { silent = false }),
        },
        ...
        ['<leader>PS'] = { ':Pipenv! sync ', desc('Prompt To Sync (Verbose)', { silent = false }) },
        ['<leader>PU'] = {
          ':Pipenv! uninstall ',
          desc('Prompt To Uninstall (Verbose)', { silent = false }),
        },
        ['<leader>PV'] = { ':Pipenv! verify<CR>', desc('Verify (Verbose)') },
        ['<leader>Pc'] = { ':Pipenv clean<CR>', desc('Clean') },
        ['<leader>PdI'] = {
          ':Pipenv! install dev=true ',
          desc('Prompt Install (Verbose)', { silent = false }),
        },
        ...
        ['<leader>PdS'] = {
          ...
          desc('Prompt To Sync (Verbose)', { silent = false }),
        },
        ['<leader>PdU'] = {
        ...
        ['<leader>Pdi'] = {
          ':Pipenv install dev=true ',
          desc('Prompt To Install', { silent = false }),
        },
        ...
        ['<leader>Pdps'] = {
          ':Pipenv! sync dev=true pre=true ',
          desc('Prompt To Sync', { silent = false }),
        },
        ['<leader>Pdpu'] = {
          ':Pipenv uninstall dev=true pre=true ',
          desc('Prompt To Uninstall', { silent = false }),
        },
        ['<leader>Pds'] = { ':Pipenv! sync dev=true ', desc('Prompt To Sync', { silent = false }) },
        ['<leader>Pdu'] = {
          ':Pipenv uninstall dev=true ',
          desc('Prompt To Uninstall', { silent = false }),
        },
        ...
        ['<leader>Pps'] = { ':Pipenv! sync pre=true ', desc('Prompt To Sync', { silent = false }) },
        ['<leader>Ppu'] = {
          ':Pipenv uninstall pre=true ',
          desc('Prompt To Uninstall', { silent = false }),
        },
        ['<leader>Pr'] = { ':Pipenv run ', desc('Prompt To Run', { silent = false }) },
        ['<leader>Ps'] = { ':Pipenv! sync ', desc('Prompt To Sync', { silent = false }) },
        ['<leader>Pu'] = { ':Pipenv uninstall ', desc('Prompt To Uninstall', { silent = false }) },
