...
return { ---@type LazySpec[]
  {
    ...
    config = function()
      require('rose-pine').setup({
        ...
        enable = { legacy_highlights = true, migrations = true, terminal = vim.o.termguicolors },
  ...
  },
  {
    ...
    config = function()
      require('catppuccin').setup({
        ...
        dim_inactive = { enabled = true, percentage = 0.20, shade = 'dark' },
        flavour = 'auto',
        ...
        integrations = {
          ...
          gitsigns = true,
          headlines = false,
          indent_blankline = { colored_indent_levels = true, enabled = false, scope_color = 'teal' },
          lsp_trouble = true,
          markdown = true,
  ...
  },
  {
    ...
    config = function()
      require('kanagawa').setup({
        ...
        terminalColors = vim.o.termguicolors,
        transparent = false,
    ...
    config = function()
      require('vague').setup({
        ...
        plugins = {
          ...
          neotest = { adapter_name = 'bold', focused = 'bold' },
